...
const LatestSubarticle = (props) => {
  const { articleTitle, articleDetails, articleAuthor, articleDateAndTime } = props; 
  return (
    <div className = "latest-article"> 
      <div className = "latest-article__info">
        ...
        <h3 className = "latest-article__info__date-time"> {articleDateAndTime} </h3>
      </div>
      <img src = "http://www.fillmurray.com/g/140/100" className="latest-article__picture" alt="article"></img>
    </div>
  )
}
